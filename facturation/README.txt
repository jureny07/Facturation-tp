...
---------------------
  ...
  Pour cela, modifiez manuellement data/utilisateurs.json :
  Générez un hash avec PHP : php -r "echo password_hash('NOUVEAU_MDP', PASSWORD_DEFAULT);"
...
HÉBERGEMENT GITHUB
-------------------
  https://github.com/[votre-groupe]/supercaisse-upc-l2

NOTE ANTI-PLAGIAT
-----------------
Ce code a été entièrement rédigé par le groupe. Toute copie
partielle ou totale entraîne la note de zéro pour les deux parties.
